<!-- 
  ...
  Title: SainmaVerse - Advanced Movie Ticket Booking System
  Description: A high-performance SainmaVerse built with Java, Spring Boot, and React. Featuring a premium dark-mode UI, seat selection, and REST API.
  Keywords: SainmaVerse, Movie Booking System, Spring Boot React, Full Stack Java, Movie App
-->

# 🎬 SainmaVerse - Advanced Movie Ticket Booking System

A high-performance **SainmaVerse** and **Movie Ticket Booking System**. This project is a comprehensive **Full-Stack Java Project** featuring a **Spring Boot** backend and a **React 19** frontend with **Premium UI/UX**.
